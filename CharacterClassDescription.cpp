...
std::string Apothecary::_description = "Apothecaries ply their trade in many of the towns and Villages of Terrinoth."
...
std::string Bard::_description = "Trained at Bardic colleges, Bards learn dozens of instruments, songs, sagas, and scrapes of lore "
...
std::string Brawler::_description = "Self-taught fighters of hand to hand combat,"
...
std::string Knight::_description = "Noble warriors traiend in all arts of combat and outfitted with the finest weapons and armour by their "
" noble patron or order; all knights uphold to the codes and ideals of"
" chivalry and nobility.";

std::string Sage::_description = "A seeker of knowledge and ancient magic,"
"Sages dedicate most of their lives to reading, writing, and studying of ancient books "
"and all forms of arcana";

std::string Thief::_description = "Thieves are those who are in the buisness and practice of illegal behavior and trade"
"many Theifs are trained in the \n art of deception and stealth"
"peffering to  avoid combat and violence if possible";

std::string Wildlander::_description = "Hardy, independent folks,"
